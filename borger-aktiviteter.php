...
<div class="container-fluid bg-sage-green ps-4 ps-md-5 pb-md-2 borger-forside-header" >
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="inter header-text-inter pe-4 pe-md-5 me-md-5 text-center">Som beboer på Vedelsbo forventes der at du deltager i hverdagens fælles opgaver i det omfang, du kan. Vi tilpasser sammen omfanget af din deltagelse, til dit funktionsniveau og ud fra dine individuelle behov.</div>
        </div>
    ...
    <div class="accordion-item mb-3 border-0 overflow-hidden bg-light-green rounded-5">
        ...
        <div id="naturholdet" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
            <div class="accordion-body bg-light-green inter accordion-body-text">
                ...
                <p class="mb-3">Tre dage ugentligt i sommerhalvåret og to dage ugentligt i vinterhalvåret deltager beboerne i praktiske opgaver på Vedelsbos udearealer som led i et relations- og aktivitetsbaseret tilbud.</p>
