...
<div class="container-fluid bg-sage-green ps-4 ps-md-5 pb-md-2 borger-forside-header d-block d-md-none">
    ...
    <div class="row">
        <div class="col-12 mt-5">
            <h1 class="cormorant pe-4 pt-3 fw-bold header-text-cormorant text-center">Om Vedelsbo</h1>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="font-twelve inter pe-4 pe-md-5 me-md-5 text-center">
                Vedelsbo er visiteret til 10 beboere, heraf 6 fleksible §107/108 og 4 §107 pladser.
            </div>
        </div>
...
<!--wave shape-->
<div aria-hidden="true" class="text-end decoration-frontpage d-block d-md-none" style="margin-top: -120px">
    ...
    <div class="row justify-content-center px-1">
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="col-12 col-lg-8">
                ...
                <p class="inter header-text-inter px-3 mb-1">
...
<div aria-hidden="true" class="beige-normal-wave-upside-down-underpage d-block d-md-none">
    <img src="waves-phone/beige-normal-wave-upside-down.png" class="waves img-fluid  p-0 m-0" alt="">
</div>

<!--personale-->
<div class="container d-flex justify-content-center align-items-center d-block d-md-none">
...
<div class="pb-2 bg-light-brown pt-5 hensyn-og-regler-section d-none d-md-block d-lg-none" id="nav-hensynogregler">
    ...
    <!--accordions-->
    <div class="accordion mt-0 mx-4 w-50 mt-0 mx-auto" id="accordionExample">
        <div class="accordion-item mb-3 border-0 overflow-hidden bg-light-green rounded-5">
            <h2 class="accordion-header">
                <button class="font-twelve accordion-button collapsed bg-light-green inter fw-bold"
                        type="button"
...
<div class="container d-flex justify-content-center align-items-center d-none d-md-block d-lg-none" id="nav-kontakt-md">
    <div class="row justify-content-center px-1">
        <div class="col-12 col-lg-8">
            <div class="text-center pt-3">
                <strong class="allura pt-2 d-block header-text-allura-underpage header-text-allura-underpage-line-height fw-normal pb-2">
                    Kontakt
                </strong>
            </div>
            <!--Profession-->
            <div class="row align-items-start pt-2">
                <div class="col-md-6">
                    <p class="font-sixteen inter fw-bold px-3 mb-3">
                        Socialpsykiatriske botilbud Vedelsbo ApS
                    </p>
                    <!-- CVR -->
                    <p class="font-sixteen inter px-3 mb-3">
...
<!--beige normal wave upside down - DESKTOP-->
...
<!--personale + hensyn og regler - DESKTOP-->
