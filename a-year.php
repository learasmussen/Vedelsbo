...
<div aria-hidden="true">
    <img src="waves-phone/navwave.png" class="d-md-none waves position-relative w-100" alt="">
</div>
...
<div class="container-fluid d-md-none p-0 position-relative" style="z-index: -1000">
    <img src="images/borger-a-year-header-image-phone.png" alt="header-image" class="img-fluid header-image-borger d-md-none">
</div>
...
<!--image-->
<div class="container-fluid d-md-none p-0 position-relative" style="z-index: -1000">
    <img src="images/borger-a-year-image-one-phone.png" alt="header-image" class="img-fluid header-image-borger-fritid d-md-none">
</div>
...
<div class="container-fluid d-none d-md-flex d-lg-none justify-content-center align-items-center bg-sage-green ps-4 pt-md-0 ps-md-0 pb-md-2 borger-forside-header" style="margin-top: 110px" >
    ...
    <div class="row d-md-flex justify-content-center align-items-center">
        <div class="col-10 mt-0">
            <h1 class="cormorant  fw-bold header-text-cormorant text-center">Årets gang</h1>
        </div>
...
<div class="container d-none d-md-flex d-lg-none justify-content-center align-items-center mt-3 pb-2">
    ...
    <div class="row justify-content-center px-1">
        ...
        <div class="col-12">
            ...
            <p class="inter font-sixteen header-text-inter px-5 mb-3">
                På Vedelsbo prioriteres traditioner højt, og højtider fejres som udgangspunkt på traditionel vis,
                herunder jul, nytår og påske. Der afholdes årligt sommerfest og julearrangement, hvor beboere, pårørende
                og venner inviteres til deltagelse.
            </p>

            <p class="inter font-sixteen header-text-inter px-5 mb-0">
                Sankt Hans fejres i haven som en fast tradition, hvor de nærmeste naboer inviteres som en del af
                fællesskabet. Beboerne opfordres løbende til at komme med idéer og ønsker, særligt i forbindelse med
                beboermøder, hvor forslag til aktiviteter planlægges og drøftes.
            </p>
...
<div class="container-fluid d-none d-lg-flex justify-content-center align-items-center bg-off-white">
    <div class="row d-flex justify-content-center align-items-center pb-3">
        ...
        <div class="col-6 ps-5 pb-3">
            <img src="image-shapes/image-14.png" alt="" class="img-fluid" style="width: 400px;">
        </div>
...
<div class=" container d-none d-md-none d-lg-block mt-4 pb-3">
    <div class="row">
        <img src="decoration-image-shapes/image-8.png" class="col-4" alt="">
        <img src="decoration-image-shapes/image-9.png" class="col-4" alt="">
