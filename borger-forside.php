...
<!--shapes-->
<div class="container d-flex d-md-none justify-content-center align-items-center hverdag-shapes-borger-forside">
        ...
        <div class="col-12 col-md-6 col-lg-6 text-center mt-3">
            ...
            <div class="shape-box-1">
                ...
                <div class="shape-content">
                    <strong class="cormorant d-block mb-2 mt-4 front-page-shape-header">
                        AKTIVITETER
                    </strong>
...
<!--citat fra jette-->
<div class="container-fluid mt-0 d-flex d-md-none justify-content-center align-items-center bg-sage-green  ">
...
<div aria-hidden="true" class="beige-big-wave-borger-forside d-none d-md-block d-lg-none">
    <img src="waves-tablet/beige-big-wave.png" class="waves img-fluid  p-0 m-0" alt="">
</div>

<!--shapes - TABLET-->
<div class="container d-none d-md-flex d-lg-none justify-content-center align-items-center hverdag-shapes-borger-forside">
    <div class="row justify-content-center">
...
<!--bottom-wave - TABLET-->
<div class="bg-dark-green d-none d-md-block d-lg-none" aria-hidden="true">
