...
<!--bottom wave-->
<div aria-hidden="true" class=" green-wavywave-frontpage d-md-none bg-dark-green">
...
<!--top-info - TABLET-->
<div class="container-fluid d-none d-md-flex d-lg-none justify-content-center align-items-center bg-sage-green borger-forside-header pt-md-0"
...
<div aria-hidden="true" class="d-none d-md-block green-wavywave-frontpage d-lg-none">
    <img src="waves-tablet/green-normal-wave.png" class="waves img-fluid  p-0 m-0" alt="">
</div>

<!--kriterier - TABLET-->
<div class="container d-flex justify-content-center align-items-center mt-3 d-md-block d-none d-lg-none">
...
<div aria-hidden="true" class=" green-wavywave-frontpage bg-light-brown d-md-block d-none d-lg-none">
    <img src="waves-tablet/beige-normal-wave.png" class="waves img-fluid  p-0 m-0" alt="">
</div>

<!--read too section tablet - TABLET-->
<div class="container-fluid mt-0 d-none d-md-block d-md-flex d-lg-none justify-content-center align-items-center bg-light-brown">
...
<div class="container-fluid d-none d-lg-block justify-content-center align-items-center ps-4 pt-md-0 ps-md-0 pb-md-2 borger-forside-header mt-3"  >
    ...
    <div class="row d-md-flex justify-content-center align-items-center">
        <div class="col-10 mt-0">
            <h1 class="cormorant mb-4  fw-bold header-text-cormorant text-center">Målgruppe</h1>
        </div>
        <div class="col-10 mb-3">
...
<div class="container-fluid d-none d-lg-flex justify-content-center align-items-center bg-off-white">
    <div class="row d-flex justify-content-center align-items-center my-3">
        ...
        <div class="col-12 px-5 mx-5 pb-3">
