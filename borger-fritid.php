...
<div aria-hidden="true" class="text-end d-md-none decoration-frontpage" style="margin-top: -120px">
    <img src="header-shapes/green-walker.png" class="decoration-frontpage-image  pe-4 m-0" alt="" style="width: 140px">
</div>
...
<div aria-hidden="true" class="text-end d-none d-md-block d-lg-none decoration-frontpage" style="margin-top: -210px">
    <img src="header-shapes/green-walker.png" class="decoration-frontpage-image  pe-4 m-0" alt="" style="width: 180px">
</div>
...
<div class="container-fluid d-none d-md-flex d-lg-none justify-content-center align-items-center bg-sage-green ps-4 pt-md-0 ps-md-0 pb-md-2 borger-forside-header" style="margin-top: 110px" >
    ...
    <div class="row d-md-flex justify-content-center align-items-center">
        <div class="col-10 mt-0">
            <h1 class="cormorant  fw-bold header-text-cormorant text-center">Fritid</h1>
        </div>
...
<div class="container d-none d-md-block d-flex d-lg-none justify-content-center align-items-center mt-3">
...
<div class="container d-none d-md-flex d-lg-none justify-content-center align-items-center">
    ...
    <div class="row justify-content-center px-1">
        ...
        <div class="col-12 col-lg-8">
            ...
            <p class="font-twelve font-sixteen inter px-4 mb-0">
                Vedelsbo tilbyder årligt fælles ferie, hvor beboerne har medindflydelse på feriemål. Ferierne kan både
                være rejser i udlandet og ophold i Danmark. For beboere der ikke deltager i fællesferien, planlægges der
                alternative aktiviteter og dags ture ud af huset med fokus på trivsel og hyggelige oplevelser. Der er
                desuden mulighed for individuelle rejser i ind- eller udland sammen med kontaktpersonen enten alene
...
<div aria-hidden="true" class="text-end d-none d-lg-block decoration-frontpage" style="margin-top: -100px">
    <img src="header-shapes/green-walker.png" class="decoration-frontpage-image  pe-4 m-0" alt="" style="width: 200px">
</div>
...
<div class="container-fluid d-none d-lg-block justify-content-center align-items-center ps-4 pt-md-0 ps-md-0 pb-md-2 borger-forside-header mt-3"  >
    ...
    <div class="row d-md-flex justify-content-center align-items-center">
        <div class="col-10 mt-0">
            <h1 class="cormorant mb-4  fw-bold header-text-cormorant text-center">Fritid</h1>
        </div>
        <div class="col-10 mb-3">
